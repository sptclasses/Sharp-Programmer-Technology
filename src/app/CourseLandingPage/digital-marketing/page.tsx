        ...
        <section id="overview" className="scroll-mt-32">
          <div className="bg-white shadow-md rounded-xl p-6">
            ...
            <div className="text-gray-800 space-y-5">
              <p>
                The Digital Marketing is a foundational computer literacy program designed to equip learners with essential IT skills for personal, academic, and professional use. It provides a strong understanding of computer operations, applications, and the internet, enabling participants to confidently use digital tools in everyday life.
              </p>
              <div>
