...
export default function Hero({ scrollToSection }: HeroProps = {}) {
  ...
  return (
    <section id="home" className="relative h-[90vh] flex items-center justify-center text-center overflow-hidden pt-32 md:pt-40 lg:pt-48">
      ...
      <div className="relative z-10 text-white max-w-4xl px-5">
        <h1
          className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold mb-6 leading-snug sm:leading-tight md:leading-tight"
